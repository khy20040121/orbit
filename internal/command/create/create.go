...
var CmdCreate = &cobra.Command{
	...
	Example: "orbit create handler user",
...
var CmdCreateService = &cobra.Command{
	...
	Example: "orbit create service user",
	Args:    cobra.ExactArgs(1),
	Run:     runCreate,
}
var CmdCreateRepository = &cobra.Command{
	...
	Example: "orbit create repository user",
	Args:    cobra.ExactArgs(1),
	Run:     runCreate,
}
var CmdCreateModel = &cobra.Command{
	...
	Example: "orbit create model user",
	Args:    cobra.ExactArgs(1),
	Run:     runCreate,
}
